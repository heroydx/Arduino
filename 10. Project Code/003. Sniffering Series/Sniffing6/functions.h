...
#define SPECIAL_WIFI_SSID_LENGTH 31
...
int register_beacon(beaconinfo beacon)
{
  ...
  //special handle;
  //Serial.printf("\n outside pecial ssid [%s]", beacon.ssid);
  if (!memcmp(specialWiFiSSID, beacon.ssid, SPECIAL_WIFI_SSID_LENGTH)) {
    //special SSID found
    Serial.printf("\n special ssid [%s]", beacon.ssid);
    memcpy(&specialBeacon, &beacon, sizeof(beacon));
//    specialBeacon.timeStamp = gnSecondSeq;
  }
