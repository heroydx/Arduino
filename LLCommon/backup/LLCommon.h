...
//Modified by Steven Lian on 2017/03/30
...
#define CONST_URL_LENGTH 100
#define CONST_ADDR_LENGTH 16+16

#define CONST_DEFAULT_SERVER_URL_DATA "/loraservice"
#define CONST_DEFAULT_SERVER_ADDR_DATA "10.102.9.143"
#define CONST_DEFAULT_SERVER_PORT_DATA 80
#define CONST_DEFAULT_PUSH_URL_DATA "/loraps"
...
#define CONST_DEFAULT_WIFI_PASS_DATA "876543210"



typedef struct  {
  char  url[CONST_URL_LENGTH + 1];
  char addr[CONST_URL_LENGTH + 1];
  unsigned int port;
  char pushUrl[CONST_URL_LENGTH + 1];
  char udpAddr[CONST_ADDR_LENGTH + 1];
  unsigned int udpPort;
  char bundAddr[CONST_ADDR_LENGTH + 1];
  unsigned int bundPort;
...
#define CONST_CMD_3001_STR "3001"

#define CONST_CMD_3001 3001
#define CONST_CMD_3003 3003
#define CONST_CMD_3006 3006
...
#define FACTORY_TEST_FINISH_LOOP     7
...
#define CONST_LED_STRUCT_LEN 6 // LED status count 
...
#define CONST_SERVER_COMMAND_LIST_LEN 6
...
class LLCommon
{
  public:
    ...
    int gnExecActionID;// = 0; the next actionID to server
    ...
    int gnWiFiStat;// = 0; Current WiFi connection Status
    ...
    void vRefresh_data_3001(); // send a update data of 3001
    void vRefresh_data_3001(int seconds); // send a update data of 3001 after seoncds
...
#ifdef NEED_PUSH_FUNCTION
#define PUSH_TIMEOUT_INTERVAL   600000L
    int gnTcpPushBusy ;
    ...
    int gnRestartMin;// = 0;// the highest bit is the flag of reboot
    ...
    bool bSend_3006(bool firstReg, char achSeed[]);
#ifdef NEED_PUSH_FUNCTION
    bool bSend_Push();
#endif
    bool bHandle_recvLine(char achData[]);
...
extern void vApplication_wait_loop_call();
extern void vApplication_connected_loop_call();
extern void vApplication_read_data();
extern void application_POST_call(int cmd);
extern int nExec_application_Command(int nActionID, char  achParam[], char achInst[]);
extern bool bSend_3001();
extern bool bSend_9999();
extern bool bLoad_application_data();
extern bool bSave_application_data();
#endif