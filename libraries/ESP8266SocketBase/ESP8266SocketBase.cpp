...
void ESP8266SocketBase::onData( void (*function)(ESP8266Socket&, char *, unsigned short) )
{
	onClientDataCb = function;
}

// tcp
void ESP8266SocketBase::onConnected( void (*function)(ESP8266Socket&) )
{
...
void ESP8266SocketBase::onReconnect( void (*function)(ESP8266Socket&, sint8) )
{
