...
#define CONST_LVCOMMON_VERSION 170629
...
#define CONST_MIN_POST_INTERVAL_TICK 200
...
#define CONST_DEFAULT_SERVER_URL_DATA "/py"
#define CONST_DEFAULT_SERVER_ADDR_DATA "ss1.chakonger.net.cn"
#define CONST_DEFAULT_SERVER_PORT_DATA 80
#define CONST_DEFAULT_PUSH_URL_DATA "/ps"
...
#define CONST_DEFAULT_WIFI_SSID_DATA "chakongerconfig"
#define CONST_DEFAULT_WIFI_PASS_DATA "12345678"
...
//shulong pin definition: for tag
//#define CONST_LED_COLOR_RED_PIN 15
//#define CONST_LED_COLOR_GREEN_PIN 5
//#define CONST_LED_COLOR_BLUE_PIN 4

//shulong sniffering button definition
//#define CONST_LED_COLOR_RED_PIN 4
//#define CONST_LED_COLOR_GREEN_PIN 4
//#define CONST_LED_COLOR_BLUE_PIN 4
...
class LVCommon
{
  public:
    ...
    //function
    LVCommon(); //constructor
    LVCommon(int nType); //constructor
    virtual ~LVCommon(); // de-constructor
...
#define CONST_FORCE_POST_CHECK_TIME_TICK_COUNT 5
...
#define CONST_TCP_COMMAND_BUSY_TIME_OUT 1
    ...
    void func_LV_CONFIG_START_STATE();
    void func_LV_CONFIG_DONE_STATE();
