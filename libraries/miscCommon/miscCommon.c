...
unsigned short ICACHE_FLASH_ATTR nReset_seconds()
{
  return secondCount;
}

unsigned short ICACHE_FLASH_ATTR nGet_seconds(unsigned short checkSeconds)
{
...
unsigned short ICACHE_FLASH_ATTR nAdd_seconds(unsigned short addSeconds)
{
